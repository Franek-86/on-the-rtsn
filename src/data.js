export const quizArr = [
  ...
  },
  {
    ...
    category: "games",
    difficulty: "medium",
    text: `Before going to a football match why don't we stop for some video games and a beer at the "Lobby E-Games" pub, are you a video games expert? This quiz requires good knowledge of them as it is not one of the easier of this tour.`,
  },
  {
    amount: "1",
    category: "sport",
